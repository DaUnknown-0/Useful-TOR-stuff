    ...
    public static class MeetingDurationOverride {
        ...
        public static void CreateOptions() {
            try {
                ...
                DiscussionBase     = CustomOption.Create(1211, Types.General, "Discussion Base Time", 15f, 0f, 120f, 1f, Enabled);
                DiscussionPerAlive = CustomOption.Create(1212, Types.General, "Discussion Per Alive Player", 0f, 0f, 30f, 0.5f, Enabled);
                DiscussionPerDead  = CustomOption.Create(1213, Types.General, "Discussion Reduction Per Dead Player", 0f, 0f, 30f, 0.5f, Enabled);
                VotingBase         = CustomOption.Create(1214, Types.General, "Voting Base Time", 30f, 0f, 120f, 1f, Enabled);
                VotingPerAlive     = CustomOption.Create(1215, Types.General, "Voting Per Alive Player", 0f, 0f, 30f, 0.5f, Enabled);
                VotingPerDead      = CustomOption.Create(1216, Types.General, "Voting Reduction Per Dead Player", 0f, 0f, 30f, 0.5f, Enabled);
